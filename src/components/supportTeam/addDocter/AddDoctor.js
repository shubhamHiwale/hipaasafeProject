              ...
              <Form className="mt-4">
                <Row>
                  <Col className="col-sm-4 mb-4">
                    ...
                    <InputGroup>
                      <InputGroup.Text id="basic-addon1"><i class="fa fa-user-o" aria-hidden="true"></i></InputGroup.Text>
                        <FormControl className="p-4" placeholder="Name" aria-label="name" aria-describedby="Name"/>
                    </InputGroup>
                  </Col>
